...
void init_Socios(eSocio socios[], int tam)
{
    ...
    char nombre[10][31]= {"Pepe","Lautaro","Jon","Bill ","Charlie","Laura","Miriam","Sansa","Bran ","Lydia"};
    char apellido[10][31]= {"Silva","Galarza","Snow","licker","Day","Jurez","Silva","Stark","Stark","Diaz"};
    char sexo[10]= {'M','M','M','M','M','F','F','F','M','F'};
    char telefono[10][31]= {"234-123","123-234","942-573","195-946 ","123-567","524-873","246-631","246-123","554-978 ","432-135"};;
    char eMail[10][31]= {"Silva@out.com","Lautaro12@out.com","Sn0w@yah.com","licker@off.com","Da1@yah.com","Silva21@out.com","Miriamq2@off.com","Stark@yah.com","Stark2@off.com","Diaz1@out.com"};;
...
int  modificar_Socios(eSocio lista[], int tam)
{
    ...
    for(i=0; i<tam; i++)
    {
        if(lista[i].isEmpty==OCUPADO)
        {
            printf("\nCodigo socio %d",lista[i].codigoSocio);
        }
    }
...
int baja_Socios(eSocio lista[], int tam)
{
    ...
    for(i=0; i<tam; i++)
    {
        if(lista[i].isEmpty==OCUPADO)
        {
            printf("\nLegajo socio %d",lista[i].codigoSocio);
        }
    }
